...
class AreaCode(Enum):
    ...
    RUSSIA = ("10Y1001A1001A49F", "SCA|RU, MBA|RU, BZN|RU, CTA|RU", "Russia ", "RU")
    RUSSIA_KALININGRAD = (
        "10Y1001A1001A50U",
    ...
    BELARUS = ("10Y1001A1001A51S", "SCA|BY, MBA|BY, BZN|BY, CTA|BY", "Belarus ", "BY")
    IRELAND_SEM = (
        "10Y1001A1001A59C",
    ...
    NORWAY_NO1A = ("10Y1001A1001A64J", "BZN|NO1A", "Norway NO1A ", "NO1A")
    DENMARK = ("10Y1001A1001A65H", "Denmark (DK)", "Denmark ", "DK")
    IT_GR = ("10Y1001A1001A66F", "BZN|IT-GR", "Italy-Greece ", "IT-GR")
    IT_NORTH_SI = (
        "10Y1001A1001A67D",
        "BZN|IT-North-SI",
        "Italy North-Slovenia ",
        "IT-North-SI",
    )
    IT_NORTH_CH = (
        "10Y1001A1001A68B",
    ...
    DENMARK_CTA = ("10Y1001A1001A796", "CTA|DK", "Denmark Control Area ", "DK")
    IT_NORTH_AT = (
        "10Y1001A1001A80L",
        "BZN|IT-North-AT",
        "Italy North-Austria ",
    ...
    GERMANY = ("10Y1001A1001A83F", "Germany (DE)", "Germany ", "DE")
    IT_MACROZONE_NORTH = (
        "10Y1001A1001A84D",
    ...
    IT_MALTA = ("10Y1001A1001A877", "BZN|IT-Malta", "Italy-Malta ", "IT-Malta")
    IT_SACOAC = ("10Y1001A1001A885", "BZN|IT-SACOAC", "Italy SACOAC ", "IT-SACOAC")
    IT_SACODC = (
        "10Y1001A1001A893",
    ...
    MOLDOVA = ("10Y1001A1001A990", "MBA|MD, SCA|MD, CTA|MD, BZN|MD", "Moldova ", "MD")
    ARMENIA = ("10Y1001A1001B004", "Armenia (AM), BZN|AM, CTA|AM", "Armenia ", "AM")
    GEORGIA = (
        "10Y1001A1001B012",
    ...
    CORE_REGION = ("10Y1001C--00059P", "REG|CORE", "Core Region ", "CORE")
    AFRR_REGION = ("10Y1001C--00090V", "REG|AFRR, SCA|AFRR", "AFRR Region ", "AFRR")
    SWE_REGION = ("10Y1001C--00095L", "REG|SWE", "SWE Region ", "SWE")
    IT_CALABRIA = (
        "10Y1001C--00096J",
    ...
    GB_IFA = ("10Y1001C--00098F", "BZN|GB(IFA)", "Great Britain IFA ", "GB")
    KOSOVO = (
        "10Y1001C--00100H",
    ...
    INDIA = ("10Y1001C--00119X", "SCA|IN", "India ", "IN")
    NORWAY_NO2A = ("10Y1001C--001219", "BZN|NO2A", "Norway NO2A ", "NO2A")
    ITALY_NORTH_REG = (
        "10Y1001C--00137V",
        "REG|ITALYNORTH",
        "Italy North Region ",
    ...
    GRIT_REGION = ("10Y1001C--00138T", "REG|GRIT", "GRIT Region ", "GRIT")
    ALBANIA = (
        "10YAL-KESH-----5",
    ...
    POLAND_LFB = ("10YCB-POLAND---Z", "LFB|PL", "Poland LFB ", "PL")
    SI_HR_BA = (
        "10YCB-SI-HR-BA-3",
        "LFB|SI_HR_BA",
    ...
    DENMARK_DK1A = ("10YDK-1-------AA", "BZN|DK1A", "Denmark DK1A ", "DK1A")
    DENMARK_DK1 = (
        "10YDK-1--------W",
    ...
    LT_SE4 = ("10YDOM-PL-SE-LT2", "BZA|LT-SE4", "Lithuania-Sweden SE4 ", "LT-SE4")
    CWE_REGION = ("10YDOM-REGION-1V", "REG|CWE", "Central Western Europe ", "CWE")
    SPAIN = (
        "10YES-REE------0",
    ...
    LUXEMBOURG = ("10YLU-CEGEDEL-NQ", "Luxembourg (LU), CTA|LU", "Luxembourg ", "LU")
    LATVIA = (
        "10YLV-1001A00074",
    ...
    GB_ELECLINK = (
        "11Y0-0000-0265-K",
        "BZN|GB(ElecLink)",
        "Great Britain ElecLink ",
        "GB",
    )
    GB_IFA2 = ("17Y0000009369493", "BZN|GB(IFA2)", "Great Britain IFA2 ", "GB")
    DK1_NO1 = ("46Y000000000007M", "BZN|DK1-NO1", "Denmark DK1-Norway NO1 ", "DK1-NO1")
    NO2NSL = ("50Y0JVU59B4JWQCU", "BZN|NO2NSL", "Norway NO2NSL ", "NO2NSL")
    BELARUS_SHORT = ("BY", "Belarus (BY)", "Belarus ", "BY")
    RUSSIA_SHORT = ("RU", "Russia (RU)", "Russia ", "RU")
    ICELAND = ("IS", "Iceland (IS)", "Iceland", "IS")

    def __init__(
        self, code: str, area_types: str, description: str, area_code: str | None = None
    ) -> None:
        self.code = code
    ...
    def get_country_code(self) -> str | None:
        """
        Extract country code from area types or description.

        .. deprecated::
            This method uses regex parsing which is insufficient for composite zones and multi-areas.
            Use the area_code property instead which provides manually curated area codes.
        """
        warnings.warn(
            "get_country_code() is deprecated. The regex extraction method is insufficient "
            "for composite zones and multi-areas. Use the area_code property instead.",
            DeprecationWarning,
            stacklevel=2,
        )

        # Return manually set area_code if available
