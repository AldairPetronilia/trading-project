...
public class LoadDomainXmlParserTest {
  ...
  void testParseActualTotalLoad() throws JAXBException, IOException {
    ...
    assertEquals(
        MarketRoleType.ISSUING_OFFICE, document.getSenderMarketParticipantMarketRoleType());
    assertEquals(
        MarketRoleType.MARKET_OPERATOR, document.getReceiverMarketParticipantMarketRoleType());
