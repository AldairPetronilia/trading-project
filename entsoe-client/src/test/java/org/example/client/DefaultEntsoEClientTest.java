 ...
 * Tests all load domain endpoints and error handling scenarios
 */
...
class DefaultEntsoEClientTest {
    ...
    @Test
    void executeRequest_WhenHttpClientThrowsException_ShouldThrowEntsoEClientException() throws Exception {
        // Given
        ...
        // When & Then
        assertThatThrownBy(() ->
                client.getActualTotalLoad(AreaCode.GERMANY,
    ...
    void parseXmlResponse_WhenInvalidXml_ShouldThrowEntsoEClientException() throws Exception {
        ...
        // When & Then
        assertThatThrownBy(() ->
                client.getActualTotalLoad(AreaCode.BELGIUM,
                        LocalDateTime.now().minusDays(1), LocalDateTime.now(), null))
                .isInstanceOf(EntsoEClientException.class)
    ...
    void parseXmlResponse_WhenEmptyResponse_ShouldThrowEntsoEClientException() throws Exception {
        ...
        // When & Then
        assertThatThrownBy(() ->
                client.getDayAheadLoadForecast(AreaCode.FRANCE,
                        LocalDateTime.now().minusDays(1), LocalDateTime.now(), null))
                .isInstanceOf(EntsoEClientException.class)
                .hasMessageContaining("Failed to parse XML response");
    }
    ...
    void constructor_WhenNullHttpClient_ShouldAcceptButFailOnClose() {
        ...
        assertThatCode(() -> clientWithNullHttp.close())
                .doesNotThrowAnyException();
    }
}
