...
/**
 * Specialized builder for ENTSO-E Load Domain API endpoints Supports all load-related data types
...
public class LoadDomainRequestBuilder {
  ...
  @NonNull private AreaCode outBiddingZoneDomain;
  ...
  /**
   * Builds EntsoEApiRequest for Actual Total Load [6.1.A] DocumentType: A65 (System Total Load)
   * ProcessType: A16 (Realised) One year range limit, minimum MTU period resolution
   */
  ...
  /**
   * Builds EntsoEApiRequest for Day-Ahead Total Load Forecast [6.1.B] DocumentType: A65 (System
   * Total Load) ProcessType: A01 (Day Ahead) One year range limit, minimum one day resolution
   */
  ...
  /**
   * Builds EntsoEApiRequest for Week-Ahead Total Load Forecast [6.1.C] DocumentType: A65 (System
   * Total Load) ProcessType: A31 (Week Ahead) One year range limit, minimum one week resolution
   */
  ...
  /**
   * Builds EntsoEApiRequest for Month-Ahead Total Load Forecast [6.1.D] DocumentType: A65 (System
   * Total Load) ProcessType: A32 (Month Ahead) One year range limit, minimum one month resolution
   */
  ...
  /**
   * Builds EntsoEApiRequest for Year-Ahead Total Load Forecast [6.1.E] DocumentType: A65 (System
   * Total Load) ProcessType: A33 (Year Ahead) One year range limit, minimum one year resolution
   */
  ...
  /**
   * Builds EntsoEApiRequest for Year-Ahead Forecast Margin [8.1] DocumentType: A70 (Load Forecast
   * Margin) ProcessType: A33 (Year Ahead) One year range limit, minimum one year resolution
   */
  ...
  private void validateBiddingZone(AreaCode areaCode) {
    if (areaCode != null && !areaCode.hasAreaType(AreaType.BZN)) {
      throw new IllegalArgumentException(
          String.format(
              "Area %s (%s) is not a valid bidding zone. Supported types: %s",
