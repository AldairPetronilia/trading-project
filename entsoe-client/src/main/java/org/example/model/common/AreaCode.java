...
public enum AreaCode {
  ...
  RUSSIA_KALININGRAD(
      "10Y1001A1001A50U", "CTA|RU-KGD, BZN|RU-KGD, MBA|RU-KGD, SCA|RU-KGD", "Russia Kaliningrad"),
  ...
  IT_BRINDISI(
      "10Y1001A1001A699", "BZN|IT-Brindisi, SCA|IT-Brindisi, MBA|IT-Z-Brindisi", "Italy Brindisi"),
  IT_CENTRE_NORTH(
      "10Y1001A1001A70O",
  ...
  IT_SARDINIA(
      "10Y1001A1001A74G", "MBA|IT-Z-Sardinia, SCA|IT-Sardinia, BZN|IT-Sardinia", "Italy Sardinia"),
  ...
  IT_ROSSANO(
      "10Y1001A1001A77A", "BZN|IT-Rossano, SCA|IT-Rossano, MBA|IT-Z-Rossano", "Italy Rossano"),
  ...
  IT_MACROZONE_NORTH(
      "10Y1001A1001A84D", "MBA|IT-MACRZONENORTH, SCA|IT-MACRZONENORTH", "Italy Macrozone North"),
  IT_MACROZONE_SOUTH(
      "10Y1001A1001A85B", "SCA|IT-MACRZONESOUTH, MBA|IT-MACRZONESOUTH", "Italy Macrozone South"),
  ...
  CZ_DE_SK_LT_SE4(
      "10Y1001C--00038X", "BZA|CZ-DE-SK-LT-SE4", "Czech Republic-Germany-Slovakia-Lithuania-SE4"),
  ...
  IT_CALABRIA(
      "10Y1001C--00096J", "SCA|IT-Calabria, MBA|IT-Z-Calabria, BZN|IT-Calabria", "Italy Calabria"),
  ...
  SWITZERLAND(
      ...
      "Switzerland"),
  MONTENEGRO(
      "10YCS-CG-TSO---S", "BZN|ME, CTA|ME, Montenegro (ME), MBA|ME, SCA|ME, LFA|ME", "Montenegro"),
  ...
  DE_TENNET_GER(
      ...
      "Germany TenneT"),
  DE_AMPRION(
      "10YDE-RWENET---I", "LFA|DE(Amprion), CTA|DE(Amprion), SCA|DE(Amprion)", "Germany Amprion"),
  DE_50HERTZ(
      "10YDE-VE-------2",
  ...
  DENMARK_DK1(
      "10YDK-1--------W", "IPA|DK1, IBA|DK1, BZN|DK1, SCA|DK1, MBA|DK1, LFA|DK1", "Denmark DK1"),
  DENMARK_DK2(
      "10YDK-2--------M", "LFA|DK2, MBA|DK2, SCA|DK2, IBA|DK2, IPA|DK2, BZN|DK2", "Denmark DK2"),
  ...
  FINLAND(
      ...
      "Finland"),
  FRANCE(
      "10YFR-RTE------C", "BZN|FR, France (FR), CTA|FR, SCA|FR, MBA|FR, LFB|FR, LFA|FR", "France"),
  GREAT_BRITAIN(
      "10YGB----------A",
      "LFA|GB, LFB|GB, SNA|GB, MBA|GB, SCA|GB, CTA|National Grid, BZN|GB",
      "Great Britain"),
  GREECE(
      "10YGR-HTSO-----Y", "BZN|GR, Greece (GR), CTA|GR, SCA|GR, MBA|GR, LFB|GR, LFA|GR", "Greece"),
  ...
  POLAND(
      "10YPL-AREA-----S", "BZN|PL, Poland (PL), CTA|PL, SCA|PL, MBA|PL, BZA|PL, LFA|PL", "Poland"),
  PORTUGAL(
      "10YPT-REN------W",
  ...
  SLOVAKIA(
      ...
      "Slovakia"),
  TURKEY(
      "10YTR-TEIAS----W", "Turkey (TR), BZN|TR, CTA|TR, SCA|TR, MBA|TR, LFB|TR, LFA|TR", "Turkey"),
  UKRAINE_BEI(
      "10YUA-WEPS-----0",
