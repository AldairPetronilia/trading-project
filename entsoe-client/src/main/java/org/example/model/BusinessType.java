...
public enum BusinessType {
    ...
    POSITIVE_FORECAST_MARGIN("A91", "Positive forecast margin (if installed capacity > load forecast)"),
    NEGATIVE_FORECAST_MARGIN("A92", "Negative forecast margin (if load forecast > installed capacity)"),
    ...
    AUTOMATIC_FREQUENCY_RESTORATION_RESERVE("A96", "Automatic frequency restoration reserve"),
    MANUAL_FREQUENCY_RESTORATION_RESERVE("A97", "Manual frequency restoration reserve"),
    ...
    public static BusinessType fromCode(String code) {
        return Arrays.stream(values())
                ...
                .findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Unknown BusinessType code: " + code));
    }
}
