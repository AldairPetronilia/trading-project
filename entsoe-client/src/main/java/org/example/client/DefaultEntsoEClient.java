...
/**
 * Default implementation of EntsoEClient for ENTSO-E Transparency Platform Load Domain API Provides
 * HTTP-based access to load data and forecasts with XML response parsing
 */
@Slf4j
public class DefaultEntsoEClient implements EntsoEClient {
  ...
  @Override
  public GLMarketDocument getActualTotalLoad(
      AreaCode biddingZone, LocalDateTime periodStart, LocalDateTime periodEnd, Integer offset)
      throws EntsoEClientException {

    log.debug(
        "Fetching actual total load for zone: {}, period: {} to {}, offset: {}",
        biddingZone.getCode(),
        periodStart,
        periodEnd,
        offset);

    EntsoEApiRequest request =
  ...
  @Override
  public GLMarketDocument getDayAheadLoadForecast(
      AreaCode biddingZone, LocalDateTime periodStart, LocalDateTime periodEnd, Integer offset)
      throws EntsoEClientException {

    log.debug(
        "Fetching day-ahead load forecast for zone: {}, period: {} to {}, offset: {}",
        biddingZone.getCode(),
        periodStart,
        periodEnd,
        offset);
  ...
  @Override
  public GLMarketDocument getWeekAheadLoadForecast(
      AreaCode biddingZone, LocalDateTime periodStart, LocalDateTime periodEnd, Integer offset)
      throws EntsoEClientException {

    log.debug(
        "Fetching week-ahead load forecast for zone: {}, period: {} to {}, offset: {}",
        biddingZone.getCode(),
        periodStart,
        periodEnd,
        offset);
  ...
  @Override
  public GLMarketDocument getMonthAheadLoadForecast(
      AreaCode biddingZone, LocalDateTime periodStart, LocalDateTime periodEnd, Integer offset)
      throws EntsoEClientException {

    log.debug(
        "Fetching month-ahead load forecast for zone: {}, period: {} to {}, offset: {}",
        biddingZone.getCode(),
        periodStart,
        periodEnd,
        offset);
  ...
  @Override
  public GLMarketDocument getYearAheadLoadForecast(
      AreaCode biddingZone, LocalDateTime periodStart, LocalDateTime periodEnd, Integer offset)
      throws EntsoEClientException {

    log.debug(
        "Fetching year-ahead load forecast for zone: {}, period: {} to {}, offset: {}",
        biddingZone.getCode(),
        periodStart,
        periodEnd,
        offset);
  ...
  @Override
  public GLMarketDocument getYearAheadForecastMargin(
      AreaCode biddingZone, LocalDateTime periodStart, LocalDateTime periodEnd, Integer offset)
      throws EntsoEClientException {

    log.debug(
        "Fetching year-ahead forecast margin for zone: {}, period: {} to {}, offset: {}",
        biddingZone.getCode(),
        periodStart,
        periodEnd,
        offset);
