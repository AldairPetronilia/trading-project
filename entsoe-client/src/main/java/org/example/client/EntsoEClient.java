...
public interface EntsoEClient extends AutoCloseable {
    ...
    /**
     * Retrieves actual total load data [6.1.A]
     ...
     */
    GLMarketDocument getActualTotalLoad(AreaCode biddingZone,
                                        LocalDateTime periodStart,
                                        LocalDateTime periodEnd,
                                        Integer offset) throws EntsoEClientException;

    /**
     * Retrieves day-ahead total load forecast [6.1.B]
     ...
     * @throws EntsoEClientException if the request fails or parameters are invalid
     */
    GLMarketDocument getDayAheadLoadForecast(AreaCode biddingZone,
                                             LocalDateTime periodStart,
                                             LocalDateTime periodEnd,
                                             Integer offset) throws EntsoEClientException;

    /**
     * Retrieves week-ahead total load forecast [6.1.C]
     ...
     * @throws EntsoEClientException if the request fails or parameters are invalid
     */
    GLMarketDocument getWeekAheadLoadForecast(AreaCode biddingZone,
                                              LocalDateTime periodStart,
                                              LocalDateTime periodEnd,
                                              Integer offset) throws EntsoEClientException;

    /**
     * Retrieves month-ahead total load forecast [6.1.D]
     ...
     * @throws EntsoEClientException if the request fails or parameters are invalid
     */
    GLMarketDocument getMonthAheadLoadForecast(AreaCode biddingZone,
                                               LocalDateTime periodStart,
                                               LocalDateTime periodEnd,
                                               Integer offset) throws EntsoEClientException;

    /**
     * Retrieves year-ahead total load forecast [6.1.E]
     ...
     * @throws EntsoEClientException if the request fails or parameters are invalid
     */
    GLMarketDocument getYearAheadLoadForecast(AreaCode biddingZone,
                                              LocalDateTime periodStart,
                                              LocalDateTime periodEnd,
                                              Integer offset) throws EntsoEClientException;

    /**
     * Retrieves year-ahead forecast margin [8.1]
     ...
     * @throws EntsoEClientException if the request fails or parameters are invalid
     */
    GLMarketDocument getYearAheadForecastMargin(AreaCode biddingZone,
                                                LocalDateTime periodStart,
                                                LocalDateTime periodEnd,
                                                Integer offset) throws EntsoEClientException;
